...
if((x>=0) && (x<15))
{
	...
	query="select  fcont,fname from file where fname='"+fname1+"' && pkey='"+pubkey1+"' && skey1='"+tskey1+"' and groups='"+group+"'";  
	
}else if((x>=15) && (x<30))
{
	 System.out.println("Between 15 to 29");
	 query="select  fcont,fname from file where fname='"+fname1+"' && pkey='"+pubkey1+"' && skey2='"+tskey1+"' and groups='"+group+"'";    
	 
}else if((x>=30) && (x<=44))
{
	 System.out.println("Between 30 to 44");
	 query="select  fcont,fname from file where fname='"+fname1+"' && pkey='"+pubkey1+"' && skey3='"+tskey1+"' and groups='"+group+"'";    
	 
}else
{
	 System.out.println("Between 45 to 59");
	 query="select  fcont,fname from file where fname='"+fname1+"' && pkey='"+pubkey1+"' && skey4='"+tskey1+"' and groups='"+group+"'";    
